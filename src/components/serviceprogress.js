import styles from "../styles/serviceprogress.module.css";
...
function Serviceprogress() {
  ...
  async function afspraakBevestigen() {
    ...
    const werkzaamhedenafspraak = document.querySelector(".werkzaamhedenafspraak");
    ...
    if (datumafspraak.value && tijdafspraak.value) {
      ...
      afspraakdata = {
        ...
        werkzaamheden: document.querySelector(".werkzaamhedenafspraak").value,
      ...
      localStorage.setItem("serviceafspraak", JSON.stringify(afspraakdata));
      let getOnderhoudsAfspraak = localStorage.getItem("serviceafspraak");
    ...
    <div className={styles.onderhoud}>
      ...
      >
        ...
        <section className='afspraakcontainercontent'>
          ...
          <p>Werkzaamheden</p>
          <textarea className="werkzaamhedenafspraak" placeholder="Optioneel, vertel hier zo specifiek mogelijk wat voor werkzaamheden je wilt. Bijvoorbeeld banden wisselen, ruitenwissers wisselen etc."></textarea>
        </section>
